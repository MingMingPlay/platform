...
export const bankList = {
    ...
    rules: {
        ...
        identityCode: [{
            ...
            {
                validator: validator.valid_IDcard,
                trigger: 'blur'
            }
        ],
        Passport: [{
...
export const rateList = {
    ...
    rules: {
        ...
        rate: [{
            ...
            {
                validator: validator.rate_number(0.01, 100),
                trigger: 'blur, change'
            },
            {
                validator: validator.validMoney,
                message: '请输入0.01到100的数字(保留两位小数)',
                trigger: 'blur, change'
            },
        ],
        money: [{
        ...
        createTime: [{
            ...
            {
                validator: validator.chooseDate,
                trigger: 'blur, change'
            },
        ],
