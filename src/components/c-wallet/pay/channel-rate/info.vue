<template>
    <div class="channel-rate">
            ...
            <el-form :model="formInfo" :rules="rules" ref="ruleForm" label-width="110px">
                ...
                <div class="detail-wrap">
                    ...
                    <el-form-item label="固定费率" label-width="108px">
                        ...
                        <el-form-item class="samllInput" v-if="formInfo.mode==='OnceCharge'" prop="money">每笔
                            <el-input :maxlength="13" v-model="formInfo.money" @change="handleMoney"></el-input> 元
                        </el-form-item>
                    ...
                    <el-form-item label="收费日期" class="ipayDate" prop="createTime">
                        <el-date-picker v-model="formInfo.createTime" type="daterange" placeholder="选择日期范围" @change="logTimeChange" :picker-options="pickerOptions0">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item>
        ...
        <div class="merchant-info" v-if="type==='edit'">
            ...
            <el-table v-loading.body="loading" :data="tableData" border style="width: 100%" stripe>
            ...
            <list-pagination v-if="loading==false && pagination" v-bind:pagination="pagination" v-on:handleSizeChange="handleSizeChange" v-on:handleCurrentChange="handleCurrentChange">
            </list-pagination>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        computed: {
            activeBreadcrumb() {
                let breadcrumbName = '新增';
                const type = this.type;
                if(type) {
                    type === 'add' ? breadcrumbName = '新增' : breadcrumbName = '编辑';
                }
...
<style scoped>
    .channel-rate .rate-info .el-form-item__content .el-input {
        width: 400px;
    }
    .channel-rate .ipayDate .el-form-item__content .el-input {
        width: 200px;
    }
    .channel-rate .rate-info .samllInput .el-input {
        width: 200px;
    }
</style>