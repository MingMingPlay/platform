<template>
    <div class="data-total">
        ...
        <div class="detail-title">激励数据统计</div>
        <div class="tips">数据更新时间：{{lastSynchTime}}</div>
        <div class="search-fil-wrap one-line">
            <el-form :model="searchForm" :inline="true">
                <el-form-item label="激励开始有效时间：">
                    <el-date-picker
                    ...
                    <p class="search-tips">仅统计激励开始时间在本时间段的激励方案</p>
                </el-form-item>
                <el-button type="primary" @click="handleSearch">搜索</el-button>
                <export-excel apiKey="statisOrganReportExportInspire" :searchForm="searchForm"></export-excel>
            </el-form>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(params){
                this.loading = true;
                this.$http.get(['statisOrganReport', 'inspire'], {params: params})
                    .then((result) => {
                        this.loading = false;
