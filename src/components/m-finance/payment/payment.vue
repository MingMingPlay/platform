...
<script>
    ...
    import { paymentListM,receiptList} from '../../../assets/staticData/finance.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                //表单头部
                columns: paymentListM.tableColumns,
                //表单详情数据
                tableData: [],
                //面包屑
                crumbs:paymentListM.crumbs,
                //时间值
                createTime:[],
                //提交的表单
                form:{
        ...
        methods: {
            ...
            handleAudit(index,row){
                this.$router.push({path:'/m_finance/bill/detail',
                    query: {
                        type:"Audit",
