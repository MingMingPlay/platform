<template>
    <div class="receiptM">
        ...
        <div class="detail-title">收款单列表</div>
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <!--<el-button-->
                        ...
                        <!--v-if="scope.row.state=='AgentCheck'">审核</el-button>-->
                    <el-button
                        size="small"
                        type="text"
...
<script>
    ...
    import { receiptListM,receiptList } from '../../../assets/staticData/finance.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                //表单头部
                columns: receiptListM.tableColumns,
                //表单详情数据
                tableData: [],
                //面包屑
                crumbs:receiptListM.crumbs,
                //时间值
                createTime:[],
                //提交的表单
                form:{
        ...
        methods: {
            ...
            handleAudit(index,row){
                this.$router.push({path:'/m_finance/receipt/detail',
                    query: {
                        type:"Audit",
