<template>
    <el-dialog class="single-banner-form" :title="parentObj.title" v-model="dialogVisible" :close-on-click-modal="false" @close="dialogClose('dialogForm')">
    ...
    export default {
        ...
        methods: {
            ...
            dialogSubmit(formName) {
                try {
                    this.broadcast('singleBannerForm', 'handleValidate');
                } catch(e) {
                    console.log(e)
                }
            },
            ...
            dialogClose() {
                try {
                    this.broadcast('singleBannerForm', 'handleResetForm');
        ...
        created() {
            ...
            /*this.$nextTick(() => {
                this.$watch('dialogForm.channelSid', (val) => {
                    this.mxDialogForm.postUrl = ['singleBanner', val];
                    this.mxDialogForm.putUrl = ['singleBanner', val || this.$route.query.channelSid, '/', this.$route.query.sid];
                });
            })*/
        }
    }
