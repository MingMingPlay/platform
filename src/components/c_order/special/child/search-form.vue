        ...
        <div class="search-fil-wrap one-line">
            <el-form :model="form" :inline="true" ref="searchForm" label-width="80px">
                ...
                <el-form-item label="买家信息" prop="userKeyword">
                    <el-input v-model="form.userKeyword" placeholder="手机号码、姓名"></el-input>
                </el-form-item>
                ...
                <el-form-item label="支付方式" prop="payChannel" clearable>
                    <el-select v-model="form.payChannel" placeholder="请选择支付方式">
                ...
                <!--<el-form-item label="代理商" prop="agentSid">
                    <el-select v-model="form.agentSid" placeholder="请选择代理商" clearable filterable remote :remote-method="handleSearchMerchants">
                        <el-option
                ...
                <el-form-item label="供货商" prop="merchantSid">
                    <el-select v-model="form.merchantSid" placeholder="请选择供货商" clearable filterable remote :remote-method="handleSearchMerchants">
                        <el-option
                            v-for="item in merchants"
                            :label="item.nameFull"
                            :value="item.sid">
