    ...
    <div class="special-order">
        ...
        <!--<div class="state-tab-wrapper">
            <el-radio-group v-model="orderType" @change="handleOrderTypeChange">
                <el-radio-button label="m">我供货的</el-radio-button>
                <el-radio-button label="a">我代理的</el-radio-button>
            </el-radio-group>
        </div>-->
...
//              sessionStorage.orderType = this.orderType;
            ...
            getAwaitingOrder() {
                pubObj.httpRequest(this, {
                    url: this.$api.order + 'special?state=2',
                    success(result) {
...
//          // 导出订单
          handleExport() {
              ...
              this.handleExportExcel(this.$api.order + 'special/excel', '行销品订单', (res) => {
...
<style>
    .special-order .state-btn-wrapper { position: relative; margin-bottom: 18px; }
