<template>
    <div class="virtual-detail">
        ...
        <div class="steps-wrap">
            <el-steps space="50%" :active="processes.len" finish-status="success" :align-center="true" :center="true">
                <el-step description="申请" :title="processes.steps[0]"></el-step>
                <el-step description="成功" :title="processes.steps[1]"></el-step>
            </el-steps>
        </div>

        <order-item order-name="refund" :order-item-data="orderDetailData" isDetail></order-item>
        ...
        <h1 class="detail-title">订单售后信息</h1>
        <div class="detail-wrap">
            <detail-block 
                :label-width="70"
                :block-static="selfDetailItem.block_fifth"
                :block-data="refund">
            </detail-block>
        </div>
...
<script>
    ...
    import { common_detail__item, refund_detail__item } from '../../../assets/staticData/order.2.0.js'
...
//          }
        ...
        created() {
            ...
            this.selfDetailItem = this.deepCopyObject(
                ...
                JSON.parse(JSON.stringify(refund_detail__item)), 
            );
        },
        beforeMount() {
            pubObj.httpRequest(this, {
                url: api.order + 'refund/process/' + this.$route.query.orderSid,
                success(result) {
        ...
        mounted() {
            pubObj.httpRequest(this, {
                ...
                success(result) {
                    ...
                    this.refund = result.data.refund;
                }
            })
        },
        ...
        methods: {
            // 深拷贝
            deepCopyObject(com, ref) {
                const new_block_first = com.block_first.concat(ref.block_first);
                com.block_first = new_block_first;
                com.block_fifth = ref.block_fifth;
...
<style>
    ...
    /*.virtual-detail .sum-total { font-size: 16px; font-weight: bold; margin-top: 16px; text-align: right; }
    .virtual-detail .sum-total span+span { margin-left: 10px; }*/
