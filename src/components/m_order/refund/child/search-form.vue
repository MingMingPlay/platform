    ...
    <div class="search-form">
        <div class="search-fil-wrap one-line">
            <el-form :model="form" :inline="true" ref="searchForm" label-width="80px">
                ...
                <el-form-item label="供货商" prop="merchantSid" v-if="isTaiping && orderType === 'sp'">
                    <el-select
                ...
                <el-form-item label="代理商" prop="agentSid" v-else-if="!isTaiping && orderType !== 'se'">
                    <el-select
                ...
                <el-form-item label="组织机构" prop="organCodes" v-if="organData.length > 0 && orderType !== 'se'">
...
//                  merchantSid: null
        ...
        watch: {
            ...
            orderType(val){
                if(val !== 'sp'){
                    this.handleSearchOrgans(this.$root.userInfo.merchantSid);
                }else {
                    this.organData = [];
                }
            },
            goodsType () {
                ...
                this.spuSid = '';
                if (this.goodsType === 'special' || this.goodsType === 'Subscribe')
        ...
        created() {
            this.$nextTick(() => {
                if(this.isTaiping) this.$set(this.form, 'merchantSid', null);
                else this.$set(this.form, 'agentSid', null);
