<template>
    <div class="virtual-detail">
        ...
        <order-item order-name="self" :order-item-data="orderDetailData" isDetail></order-item>
        ...
        <h1 class="detail-title" style="margin-top: 30px;">订单信息
            <el-button 
                type="primary" 
                style="margin-left: 20px;" 
                @click="handleDelivery(orderDetailData.orderId)"
                v-if="processes.state == 2"
                v-show="!hasDeliveried">确认发货
            </el-button>
        </h1>
        ...
        <order-delivery @refresh-data="handleRefresh"></order-delivery>
