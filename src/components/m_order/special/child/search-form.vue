    ...
    <div class="search-form">
        <div class="search-fil-wrap one-line">
            <el-form :model="form" :inline="true" ref="searchForm" label-width="80px">
                ...
                <el-form-item label="代理商" prop="agentSid" v-show="orderType === 'm'">
                    <el-select
                ...
                <el-form-item label="供货商" prop="merchantSid" v-show="orderType === 'a'">
                    <el-select
                ...
                <el-form-item label="组织机构" prop="organCodes">
                    <organ-select v-model="form.organCodes" :organ-data="organData"></organ-select>
                </el-form-item>
...
//                  merchantSid: null
        ...
        created() {
            this.$nextTick(() => {
                if(this.orderType === 'm') this.$set(this.form, 'agentSid', null);
                else this.$set(this.form, 'merchantSid', null);
