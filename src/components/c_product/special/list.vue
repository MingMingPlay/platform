    ...
    <div class="goods-self">
        ...
        <div class="search-fil-wrap">
            <el-form class="search-form" label-width="80px" :model="searchForm" :inline="true">
                ...
                <el-form-item label="供应店铺">
                    <el-select
                            v-model="searchForm.shopSid"
                            clearable
                            filterable
                            remote
                            placeholder="请输入供应店铺名称"
                ...
                <el-form-item label="代理店铺">
                    <el-select
                            v-model="searchForm.agentShopSid"
                            clearable
                            filterable
                            remote
                            placeholder="请输入代理店铺名称"
        ...
        <div class="tab-wrap">
            ...
            <div class="sort-wrap">
                <el-button type="primary" @click="exportExcel('Assist')">导出商品Excel</el-button>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            remoteMethodAgent(query) {		// 动态搜索代理商信息
                if(query === ''){
