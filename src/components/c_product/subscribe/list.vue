<template>
    <div class="goods-self">
        ...
        <div class="tab-wrap" style="height: 57px;">
            <el-tabs v-model="goodsStates" @tab-click="tabClick">
                <el-tab-pane label="全部" name="All"></el-tab-pane>
                <!--<el-tab-pane label="销售中" name="Selling"></el-tab-pane>-->
            </el-tabs>
            <div class="sort-wrap">
                <el-button type="primary" @click="exportExcel('Subscribe')">导出商品Excel</el-button>
            </div>
        </div>
    ...
    export default {
        ...
        created (){		// 页面初始化可能会遇到的情况
            ...
            if(!this.$route.query.type){
                query.type  = 'Subscribe';	// General(1, "普通商品"),Assist(2, "行销商品"),Subscribe (3, "征订商品")
            }
