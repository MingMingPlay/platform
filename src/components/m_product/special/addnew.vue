        ...
        <el-form :model="goodsBasis" ref="basisForm" :rules="rules">
            ...
            <div v-show="stepsActive === 0">
                ...
                <div class="cate-wrap">
                    ...
                    <cell-wraper title="选择代理店铺" :isRequired="true">
                        <el-form-item required prop="agentShopSid">
                            <select-agent v-model="goodsBasis.agentShopSid" :agentName="goodsBasis.agentShopName"></select-agent>
                        </el-form-item>
                    </cell-wraper>
                ...
                <div class="cate-wrap">
                    ...
                    <cell-wraper title="运费" :isRequired="true">
                        <el-form-item required prop="templateSid">
                            <select-shipping v-model="goodsBasis.templateSid"></select-shipping>
                        </el-form-item>
                    </cell-wraper>
